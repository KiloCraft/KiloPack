...
execute align xyz positioned ~.5 ~ ~.5 run summon shulker ~ ~ ~ {Color:15b,Peek:0,Silent:1b,Health:2147483647f,Attributes:[{Name:"generic.max_health",Base:2147483647}],NoAI:1b,AttachFace:0b,Tags:["kecrate_shulker", "kecrate"]}
