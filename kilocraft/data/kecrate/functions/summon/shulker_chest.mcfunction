...
execute as @e[tag=kecrate] at @s run tp @s ~ -100 ~
...
execute align xyz positioned ~.5 ~ ~.5 run summon shulker ~ ~ ~ {Color:15b,Peek:0,Silent:1b,Health:200.0f,NoAI:1b,AttachFace:0b,Tags:["kecrate_shulker", "kecrate"]}
