...
#Give the Loot
loot give @s loot kecrate:votes
...
#Remove the Key
clear @s[gamemode=survival, nbt={Inventory:[{id:"minecraft:firework_star",tag:{VoteKey:1b}}]}] minecraft:firework_star{VoteKey:1b} 1

function kecrate:shulker_animated/onopened
