tellraw @s ["",{"text":"===================== ","color":"yellow"},{"text":"Player","bold":true,"color":"#7EC9FB","clickEvent":{"action":"run_command","value":"/trigger rankinfo set 1"},"hoverEvent":{"action":"show_text","contents":[{"text":"[Click for entire list]","color":"gold"}]}},{"text":" ====================","color":"yellow"}]
