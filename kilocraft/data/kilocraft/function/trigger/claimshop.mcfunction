execute if score @s claimshop matches 1 run tellraw @s ["",{"text":"Claim shop: ","color":"gold", "bold":true},{"text":"\n"},{"text":"[1] ","color":"yellow"},{"text":"50 Claim blocks","color":"gold"},{"text":" [Buy for 1 diamond]","color":"yellow","hover_event":{"action":"show_text","value":{"text":"Click to purchase!","color":"green"}},"click_event":{"action":"run_command","command":"/trigger claimshop set -1"}},{"text":"\n"},{"text":"[2] ","color":"yellow"},{"text":"3200 Claim blocks","color":"gold"},{"text":" [Buy for 64 diamonds]","color":"yellow","hover_event":{"action":"show_text","value":{"text":"Click to purchase!","color":"green"}},"click_event":{"action":"run_command","command":"/trigger claimshop set -2"}},{"text":"\n"},{"text":"[3] ","color":"yellow"},{"text":"450 Claim blocks","color":"gold"},{"text":" [Buy for 1 diamond block]","color":"yellow","hover_event":{"action":"show_text","value":{"text":"Click to purchase!","color":"green"}},"click_event":{"action":"run_command","command":"/trigger claimshop set -3"}},{"text":"\n"},{"text":"[4] ","color":"yellow"},{"text":"28800 Claim blocks","color":"gold"},{"text":" [Buy for 64 diamond blocks]","color":"yellow","hover_event":{"action":"show_text","value":{"text":"Click to purchase!","color":"green"}},"click_event":{"action":"run_command","command":"/trigger claimshop set -4"}}]
