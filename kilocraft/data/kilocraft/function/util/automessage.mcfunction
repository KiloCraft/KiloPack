...
execute if score #keutil_automessage ke_var matches 4 run tellraw @a ["",{color:"light_purple",text:"[Event] "},{color:"aqua",text:"Did you already hear about the "},{color:"gold",text:"Snake Minigame event? "},{color:"aqua",text:"Read our latest announcement on "},{color:"blue",italic:true,text:"Discord! ",click_event:{action:"open_url",url:"https://discord.gg/Ss5muBFFGt"},hover_event:{action:"show_text",value:["",{color:"gold",text:"Click here to join the Discord!"}]}},{color:"aqua",text:"Do "},{color:"gold",text:"/minigame ",click_event:{action:"run_command",command:"/minigame"},hover_event:{action:"show_text",value:["",{color:"gold",text:"Click to join!"}]}},{color:"aqua",text:"to train your skills!"}]
