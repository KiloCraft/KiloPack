attribute @s minecraft:generic.jump_strength modifier add kilocraft:in_portal -1024 add_value
attribute @s minecraft:generic.movement_speed modifier add kilocraft:in_portal -1024 add_value
