...
# Portal logic
particle minecraft:electric_spark 282.5 64.5 -181.5 0.2 1.8 1.4 0 3 normal @a
execute as @a[x=282,y=60,z=-185,dx=0,dy=8,dz=8] run tag @s add kilocraft_in_portal_tmp
...
execute positioned 305.5 60.0 -180.5 as @a[distance=500..] at @s run tp @s 305.5 60.0 -180.5 90 0
