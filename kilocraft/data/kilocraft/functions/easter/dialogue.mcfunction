...
execute if score @s easter_dialogue matches 160..160 run give @s written_book[minecraft:written_book_content={pages: [{text: '{"extra":["Look for a sweet treat at the top level of the bakery."],"text":""}'}, {text: '{"extra":["On top of the highest mountain in a red barn, a baby chick has hatched from its shell."],"text":""}'}, {text: '{"extra":["You can find this rabbit hiding underground in the birch forest."],"text":""}'}, {text: '{"extra":["It\'s time for the Easter egg hunt! Get to jumping your way up to the top."],"text":""}'}, {text: '{"extra":["A rabbit has hidden one of the eggs away. Now, you must head to spawn and find where the rabbit has hidden it."],"text":""}'}, {text: '{"extra":["As I\'m getting ready for bed in my room at the hotel, I read a tale to help me sleep."],"text":""}'}, {text: '{"extra":["A crazy scientist has taken the baby bunnies away and is trying to experiment on them. You must find them in the run-down house."],"text":""}'}], resolved: 1b, title: {text: "Book of Hints"}, author: "Easter Bunny"}]
