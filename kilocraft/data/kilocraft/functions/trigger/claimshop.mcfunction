execute if score @s ketrigger_cs matches 1 run tellraw @s ["",{"text":"Claim shop: ","color":"gold"},{"text":"\n"},{"text":"[1] ","color":"yellow"},{"text":"25 Claim blocks","color":"gold"},{"text":" [Buy for 1 diamond]","color":"yellow","hoverEvent":{"action":"show_text","value":{"text":"Click to purchase!","color":"green"}},"clickEvent":{"action":"run_command","value":"/trigger ketrigger_cs set -1"}},{"text":"\n"},{"text":"[2] ","color":"yellow"},{"text":"1600 Claim blocks","color":"gold"},{"text":" [Buy for 64 diamonds]","color":"yellow","hoverEvent":{"action":"show_text","value":{"text":"Click to purchase!","color":"green"}},"clickEvent":{"action":"run_command","value":"/trigger ketrigger_cs set -2"}},{"text":"\n"},{"text":"[3] ","color":"yellow"},{"text":"225 Claim blocks","color":"gold"},{"text":" [Buy for 1 diamond block]","color":"yellow","hoverEvent":{"action":"show_text","value":{"text":"Click to purchase!","color":"green"}},"clickEvent":{"action":"run_command","value":"/trigger ketrigger_cs set -3"}},{"text":"\n"},{"text":"[4] ","color":"yellow"},{"text":"14400 Claim blocks","color":"gold"},{"text":" [Buy for 64 diamond blocks]","color":"yellow","hoverEvent":{"action":"show_text","value":{"text":"Click to purchase!","color":"green"}},"clickEvent":{"action":"run_command","value":"/trigger ketrigger_cs set -4"}}]
