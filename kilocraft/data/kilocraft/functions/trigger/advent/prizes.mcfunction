...
execute if entity @s[tag=!day1] if score var advent_date matches 1..2 if score @s advent matches 101 run give @s minecraft:pumpkin_pie{display:{Name:'[{"text":"Apple Pie","italic":false,"color":"red"}]',Lore:['[{"text":"Perfect for a christmas dinner!","italic":false,"color":"red"}]']}} 4
...
execute if entity @s[tag=!day3] if score var advent_date matches 3..4 if score @s advent matches 103 run give @s minecraft:red_shulker_box{display:{Name:'[{"text":"Holiday Present","italic":false,"color":"dark_red"}]',Lore:['[{"text":"To store all your presents!","italic":false,"color":"red"}]']}} 1
...
execute if entity @s[tag=!day5] if score var advent_date matches 5..6 if score @s advent matches 105 run give @s minecraft:powder_snow_bucket{display:{Name:'[{"text":"Bucket of Snow","italic":false,"color":"white"}]',Lore:['[{"text":"Real snow from the North Pole","italic":false,"color":"light_gray"}]']}} 1
...
execute if entity @s[tag=!day7] if score var advent_date matches 7..8 if score @s advent matches 107 run give @s minecraft:leather_helmet{display:{color:207918,Name:'[{"text":"Frosty\'s Magic Hat","italic":false,"color":"dark_green","bold":true}]'}} 1
...
execute if entity @s[tag=!day8] if score var advent_date matches 8..9 if score @s advent matches 108 run give @s minecraft:cooked_chicken{display:{Name:'[{"text":"Christmas Turkey","italic":false,"color":"white"}]'}} 8
...
execute if entity @s[tag=!day11] if score var advent_date matches 11..12 if score @s advent matches 111 run give @s minecraft:bell{display:{Name:'[{"text":"Sleigh Bell","italic":false,"color":"gold"}]'}} 2
...
execute if entity @s[tag=!day16] if score var advent_date matches 16..17 if score @s advent matches 116 run give @s minecraft:rabbit_stew{display:{Name:'[{"text":"Turkey Soup","italic":false,"bold":true,"color":"gold"}]'}} 1
...
execute if entity @s[tag=!day18] if score var advent_date matches 18..19 if score @s advent matches 118 run give @s minecraft:sunflower{display:{Name:'[{"text":"Tree Ornament","italic":false,"color":"green","bold":true}]'}} 1
...
execute if entity @s[tag=!day19] if score var advent_date matches 19..20 if score @s advent matches 119 run give @s minecraft:baked_potato{display:{Lore:['[{"text":"Mashed Potatoes","italic":false,"color":"yellow"}]']}} 16
...
execute if entity @s[tag=!day20] if score var advent_date matches 20..21 if score @s advent matches 120 run give @s minecraft:leather_boots{display:{color:174121,Name:'[{"text":"Christmas Stockings","italic":false,"color":"dark_green","bold":true}]'}} 1
...
execute if entity @s[tag=!day23] if score var advent_date matches 23..24 if score @s advent matches 123 run give @s minecraft:diamond_block 1
...
execute if entity @s[tag=!day25] if score var advent_date matches 25 if score @s advent matches 125 run give @s minecraft:netherite_ingot{display:{Name:'[{"text":"Chocolate Bar","italic":false,"color":"#5B3419"}]'}} 1
