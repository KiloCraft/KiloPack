...
execute if entity @s[tag=!day1] if score #advent_date ke_var matches 1..2 if score @s advent matches 101 run give @s minecraft:cookie{display:{Name:'[{"text":"Christmas Cookie","italic":false,"color":"green"}]',Lore:['[{"text":"Be sure to pair with some milk!","italic":false,"color":"red"}]']}} 16
...
execute if entity @s[tag=!day3] if score #advent_date ke_var matches 3..4 if score @s advent matches 103 run give @s minecraft:bundle{display:{Name:'[{"text":"Santa\'s Sack o\' Presents","italic":false,"color":"red"}]'}} 1
...
execute if entity @s[tag=!day5] if score #advent_date ke_var matches 5..6 if score @s advent matches 105 run give @s minecraft:milk_bucket{display:{Name:'[{"text":"Eggnog","italic":false,"color":"red"}]',Lore:['[{"text":"This sure would go nice with some cookies...","italic":false,"color":"green"}]']}} 1
...
execute if entity @s[tag=!day8] if score #advent_date ke_var matches 8..9 if score @s advent matches 108 run give @s minecraft:cooked_beef{display:{Name:'[{"text":"Christmas Roast","italic":false,"color":"white"}]'}} 24
...
execute if entity @s[tag=!day16] if score #advent_date ke_var matches 16..17 if score @s advent matches 116 run give @s minecraft:spruce_sapling{display:{Name:'[{"text":"Tiny Christmas Tree","italic":false,"bold":true,"color":"dark_green"}]',Lore:['[{"text":"Lookin\' like a Charlie Brown Christmas","italic":false,"color":"green"}]']}} 1
...
execute if entity @s[tag=!day18] if score #advent_date ke_var matches 18..19 if score @s advent matches 118 run give @s minecraft:sweet_berries{display:{Name:'[{"text":"Mistletoe","italic":false,"color":"green","bold":true}]'}} 1
...
execute if entity @s[tag=!day19] if score #advent_date ke_var matches 19..20 if score @s advent matches 119 run give @s minecraft:shulker_shell{display:{Lore:['[{"text":"To store all of your gifts!","italic":false,"color":"yellow"}]']}} 2
...
execute if entity @s[tag=!day20] if score #advent_date ke_var matches 20..21 if score @s advent matches 120 run give @s minecraft:leather_boots{display:{color:11546150,Name:'[{"text":"Christmas Stockings","italic":false,"color":"dark_red","bold":true}]'}} 1
...
execute if entity @s[tag=!day23] if score #advent_date ke_var matches 23..24 if score @s advent matches 123 run give @s minecraft:netherite_ingot 1
...
execute if entity @s[tag=!day25] if score #advent_date ke_var matches 25 if score @s advent matches 125 run give @s minecraft:diamond_block 1
