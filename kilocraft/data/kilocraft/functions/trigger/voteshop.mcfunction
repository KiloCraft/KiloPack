...
execute if score @s ketrigger_vs matches -9 if score @s kevote_credits matches 7.. run execute at @s run summon minecraft:phantom ~ ~15 ~
execute if score @s ketrigger_vs matches -9 if score @s kevote_credits matches 7.. run scoreboard players remove @s kevote_credits 7

execute if score @s ketrigger_vs matches 1 if score @s kevote_credits matches 5.. run tellraw @s [{"text":"[10] ","color":"yellow"},{"text":"1 Tadpole Bucket","color":"gold"},{"text":" [Buy for 5 credits]","color":"green","hoverEvent":{"action":"show_text","value":{"text":"Click to purchase!","color":"green"}},"clickEvent":{"action":"run_command","value":"/trigger ketrigger_vs set -10"}}]
execute if score @s ketrigger_vs matches 1 if score @s kevote_credits matches ..4 run tellraw @s [{"text":"[10] ","color":"yellow"},{"text":"1 Tadpole Bucket","color":"gold"},{"text":" [Buy for 5 credits]","italic":false,"color":"red","hoverEvent":{"action":"show_text","value":{"text":"You don't have enough credits!","color":"red"}}}]
execute if score @s ketrigger_vs matches -10 if score @s kevote_credits matches 5.. run give @s minecraft:tadpole_bucket 1
...
execute if score @s ketrigger_vs matches 1 if score @s kevote_credits matches 15.. run tellraw @s [{"text":"[11] ","color":"yellow"},{"text":"1 Swift Sneak Book","color":"gold"},{"text":" [Buy for 15 credits]","color":"green","hoverEvent":{"action":"show_text","value":{"text":"Click to purchase!","color":"green"}},"clickEvent":{"action":"run_command","value":"/trigger ketrigger_vs set -11"}}]
execute if score @s ketrigger_vs matches 1 if score @s kevote_credits matches ..14 run tellraw @s [{"text":"[11] ","color":"yellow"},{"text":"1 Swift Sneak Book","color":"gold"},{"text":" [Buy for 15 credits]","italic":false,"color":"red","hoverEvent":{"action":"show_text","value":{"text":"You don't have enough credits!","color":"red"}}}]
execute if score @s ketrigger_vs matches -11 if score @s kevote_credits matches 15.. run give @s minecraft:enchanted_book{StoredEnchantments:[{id:"minecraft:swift_sneak",lvl:3}]} 1
execute if score @s ketrigger_vs matches -11 if score @s kevote_credits matches 15.. run scoreboard players remove @s kevote_credits 15

execute if score @s ketrigger_vs matches 1 if score @s kevote_credits matches 6.. run tellraw @s [{"text":"[12] ","color":"yellow"},{"text":"Summon an Allay","color":"gold"},{"text":" [Buy for 6 credits]","color":"green","hoverEvent":{"action":"show_text","value":{"text":"Click to purchase!","color":"green"}},"clickEvent":{"action":"run_command","value":"/trigger ketrigger_vs set -12"}}]
execute if score @s ketrigger_vs matches 1 if score @s kevote_credits matches ..5 run tellraw @s [{"text":"[12] ","color":"yellow"},{"text":"Summon an Allay","color":"gold"},{"text":" [Buy for 6 credits]","italic":false,"color":"red","hoverEvent":{"action":"show_text","value":{"text":"You don't have enough credits!","color":"red"}}}]
execute if score @s ketrigger_vs matches -12 if score @s kevote_credits matches 6.. run execute at @s run summon minecraft:allay
execute if score @s ketrigger_vs matches -12 if score @s kevote_credits matches 6.. run scoreboard players remove @s kevote_credits 6

execute if score @s ketrigger_vs matches 1 if score @s kevote_credits matches 5.. run tellraw @s [{"text":"[13] ","color":"yellow"},{"text":"Mangrove Stuff","color":"gold","hoverEvent":{"action":"show_text","value":{"text":"You will get 32 Mangrove Leaves and 32 Mangrove Roots","color":"gray"}}},{"text":" [Buy for 5 credits]","color":"green","hoverEvent":{"action":"show_text","value":{"text":"Click to purchase!","color":"green"}},"clickEvent":{"action":"run_command","value":"/trigger ketrigger_vs set -13"}}]
execute if score @s ketrigger_vs matches 1 if score @s kevote_credits matches ..4 run tellraw @s [{"text":"[13] ","color":"yellow"},{"text":"Mangrove Stuff","color":"gold","hoverEvent":{"action":"show_text","value":{"text":"You will get 32 Mangrove Leaves and 32 Mangrove Roots","color":"gray"}}},{"text":" [Buy for 5 credits]","italic":false,"color":"red","hoverEvent":{"action":"show_text","value":{"text":"You don't have enough credits!","color":"red"}}}]
execute if score @s ketrigger_vs matches -13 if score @s kevote_credits matches 5.. run give @s minecraft:mangrove_leaves 32
execute if score @s ketrigger_vs matches -13 if score @s kevote_credits matches 5.. run give @s minecraft:mangrove_roots 32
execute if score @s ketrigger_vs matches -13 if score @s kevote_credits matches 5.. run scoreboard players remove @s kevote_credits 5

execute if score @s ketrigger_vs matches 1 if score @s kevote_credits matches 4.. run tellraw @s [{"text":"[14] ","color":"yellow"},{"text":"64 Mangrove Logs","color":"gold"},{"text":" [Buy for 4 credits]","color":"green","hoverEvent":{"action":"show_text","value":{"text":"Click to purchase!","color":"green"}},"clickEvent":{"action":"run_command","value":"/trigger ketrigger_vs set -14"}}]
execute if score @s ketrigger_vs matches 1 if score @s kevote_credits matches ..3 run tellraw @s [{"text":"[14] ","color":"yellow"},{"text":"64 Mangrove Logs","color":"gold"},{"text":" [Buy for 4 credits]","italic":false,"color":"red","hoverEvent":{"action":"show_text","value":{"text":"You don't have enough credits!","color":"red"}}}]
execute if score @s ketrigger_vs matches -14 if score @s kevote_credits matches 4.. run give @s minecraft:mangrove_log 64
execute if score @s ketrigger_vs matches -14 if score @s kevote_credits matches 4.. run scoreboard players remove @s kevote_credits 4
