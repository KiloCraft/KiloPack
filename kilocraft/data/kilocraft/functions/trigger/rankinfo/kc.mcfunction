tellraw @s ["",{"text":"=================== ","color":"yellow"},{"text":"Kilocrafter","bold":true,"color":"gold","clickEvent":{"action":"run_command","value":"/function woodcraft:rankinfo/list"},"hoverEvent":{"action":"show_text","contents":[{"text":"[Click for entire list]","color":"gold"}]}},{"text":" ==================","color":"yellow"}]
