...
tellraw @s ["",{"text":"[Permissions for Previous Ranks]:","bold":true,"color":"white"},"\n",{"text":"All Basic Commands, :item: in chat, /hat, /sit, /signedit, Chat Formatting, /glow, /nick, /anvil, /enderchest","color":"yellow"},"\n","\n",{"text":"[New Permissions]:","bold":true,"color":"white"},"\n",{"text":"15 claims, 7 homes, Nickname Formatting, Book Formatting, /craft","color":"yellow"}]
