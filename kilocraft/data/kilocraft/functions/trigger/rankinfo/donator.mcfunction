...
tellraw @s ["",{"text":"[Permissions (not including your playtime rank)]:","bold":true,"color":"white"},"\n",{"text":"+2 homes, Chat Formatting, Basic Nickname Formatting, Book and Anvil Coloring Without Dye, Armor Stand Editing, /signedit, /ec, /nick, /magicalparticles","color":"yellow"}]
